...
if os.path.exists('./predictions/initial_results') == False:
    os.mkdir('./predictions/initial_results')
...
pd.concat(logistic_regression, axis = 1).to_csv('./predictions/initial_results/lr_predictions.csv', index = False)
pd.concat(random_forest, axis = 1).to_csv('./predictions/initial_results/rf_predictions.csv', index = False)
pd.concat(support_vector, axis = 1).to_csv('./predictions/initial_results/sv_predictions.csv', index = False)
pd.concat(neural_network, axis = 1).to_csv('./predictions/initial_results/nn_predictions.csv', index = False)
pd.concat(ensemble_classifier, axis = 1).to_csv('./predictions/initial_results/ec_predictions.csv', index = False)
