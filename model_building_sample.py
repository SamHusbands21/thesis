...
# This code executes with differing levels of training datapoints per ML algorithm
# These predictions are saved in./predictions/datapoint_results_X
import glob
import numpy as np
import os
...
np.random.seed(21)
random.seed(21)
datapoint_counts = [100, 200, 400, 800, 1600, 3200]
